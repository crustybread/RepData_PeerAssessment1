...
You can see that the summaries are not appreciably different (except for the 3rd quarter median). But the impact of imputing missing data on the estimates of the total daily number of steps is shown below. As you would expecting, imputing a value to steps when NA significantly increases the total number of steps for taken for all days. 
...
As you can see there is greater variability of when steps are taken during the day during the weekend, as compared to a weekday, when it appears to be concentrated around the morning rush hour.
